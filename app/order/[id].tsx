...
const s = StyleSheet.create({
  header:{height:58,backgroundColor:"#FFF",paddingHorizontal:15,flexDirection:"row-reverse",alignItems:"center",justifyContent:"space-between",borderBottomWidth:1,borderColor:"#E7E7E7"},
  icon:{width:38,height:38,alignItems:"center",justifyContent:"center"},
  headerCopy:{alignItems:"center"},
  headerTitle:{fontSize:14,fontWeight:"900",color:"#171717"},
  status:{fontSize:9,color:"#8A6500",marginTop:2},
  list:{padding:12,paddingBottom:20},
  chatPicker:{flexDirection:"row-reverse",gap:7,marginBottom:10,flexWrap:"wrap"},
  chatChip:{flexDirection:"row-reverse",alignItems:"center",gap:5,paddingHorizontal:10,paddingVertical:8,borderRadius:18,borderWidth:1,borderColor:"#DDD",backgroundColor:"#FFF"},
  chatChipActive:{backgroundColor:"#111",borderColor:"#111"},
  chatChipText:{fontSize:10,color:"#555",fontWeight:"800"},
  chatChipTextActive:{color:"#FFF"},
  orderCard:{backgroundColor:"#FFF",borderRadius:14,padding:13,marginBottom:12,borderWidth:1,borderColor:"#ECECEC"},
  orderTitle:{fontSize:14,fontWeight:"900",color:"#111",textAlign:"right",marginBottom:7},
  line:{flexDirection:"row-reverse",justifyContent:"space-between",gap:10,paddingVertical:8,borderTopWidth:1,borderColor:"#F1F1F1"},
  lineCopy:{flex:1,alignItems:"flex-end"},
  lineName:{fontSize:11,fontWeight:"800",color:"#222",textAlign:"right"},
  lineMeta:{fontSize:9,color:"#777",marginTop:3},
  linePrice:{fontSize:10,fontWeight:"900",color:"#E60023"},
  total:{flexDirection:"row-reverse",justifyContent:"space-between",borderTopWidth:1,borderColor:"#EAEAEA",paddingTop:9,marginTop:5},
  totalLabel:{fontSize:12,fontWeight:"900"},
  totalValue:{fontSize:15,fontWeight:"900",color:"#E60023"},
  messageRow:{alignItems:"flex-end",marginBottom:8},
  ownRow:{alignItems:"flex-start"},
  bubble:{maxWidth:"82%",padding:10,borderRadius:13},
  ownBubble:{backgroundColor:"#111"},
  otherBubble:{backgroundColor:"#FFF",borderWidth:1,borderColor:"#EEE"},
  messageText:{fontSize:12,color:"#333",lineHeight:18,textAlign:"right"},
  ownText:{color:"#FFF"},
  attachment:{fontSize:9,color:"#777",marginBottom:4},
  time:{fontSize:8,color:"#999",marginTop:4,textAlign:"right"},
  ownTime:{color:"#CFCFCF"},
  composer:{backgroundColor:"#FFF",borderTopWidth:1,borderColor:"#E6E6E6",padding:9,flexDirection:"row-reverse",gap:8,alignItems:"center"},
  input:{flex:1,height:43,backgroundColor:"#F2F2F2",borderRadius:22,paddingHorizontal:14,fontSize:12},
  sendButton:{width:43,height:43,borderRadius:22,backgroundColor:"#E60023",alignItems:"center",justifyContent:"center"},
  disabled:{opacity:.45},
  center:{flex:1,alignItems:"center",justifyContent:"center",padding:28,gap:12},
  centerText:{fontSize:12,color:"#666",textAlign:"center"},
  darkButton:{backgroundColor:"#111",paddingHorizontal:22,paddingVertical:12,borderRadius:22},
