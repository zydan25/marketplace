...
const progress: Record<string, number> = { pending: 20, confirmed: 35, processing: 52, partially_fulfilled: 68, shipped: 80, delivered: 100, cancelled: 100, refunded: 100 };
