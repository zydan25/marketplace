...
const sections = [
  ...
  { icon: "category", label: "الفئات والعروض", text: "إضافة وإدارة الأقسام والبنرات", route: "/admin/categories" },
