...
interface DjangoApiService {
    ...
    @GET("products/")
    suspend fun getProducts(@Query("vendor") vendorId: Int? = null, @Query("search") search: String? = null, @Query("category") category: String? = null): Response<ProductResponse>
    @POST("auth/login/")
    ...
    // Customer service catalog and execution live under the stable v2 domain.
