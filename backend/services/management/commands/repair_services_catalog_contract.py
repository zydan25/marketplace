...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Only the canonical offeryem link remains active for the canonical package Service.
        ...
        # Ensure canonical Yemen Net query split exists without pretending the provider
        # query endpoint itself can distinguish ADSL from fixed line.
            ...
            for code, name, slug, setting_key, service_type, sort_order in targets:
                ...
                ServiceField.objects.update_or_create(
                    ...
                    defaults={
                        ...
                        "choices": [
                            {"value": "adsl", "label": "ADSL"} if service_type == "adsl" else {"value": "line", "label": "هاتف ثابت"}
                        ],
        ...
        self.stdout.write(self.style.SUCCESS(
            ...
            f"Yemen Mobile plans={result['created_plans']}, source rows={result['expected_source_rows']}. "
