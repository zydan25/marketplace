...
urlpatterns = [
    ...
    path("categories/main/", center, {"section": "main"}, name="admin-services-main-categories"),
    path("categories/", center, {"section": "categories"}, name="admin-services-categories"),
    path("catalog/services/", center, {"section": "services"}, name="admin-services-list"),
    path("catalog/fields/", center, {"section": "fields"}, name="admin-services-fields"),
    path("catalog/resources/", center, {"section": "resources"}, name="admin-services-resources"),
