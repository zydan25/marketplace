...
class ServiceField(TimeStampedModel):
    ...
    key=models.SlugField(max_length=100); label=models.CharField(max_length=180); field_type=models.CharField(max_length=30,choices=FieldTypes.choices,default="text")
...
class VendorCityShipping(TimeStampedModel):
    ...
    fee=models.DecimalField(max_digits=12,decimal_places=2,default=Decimal("0.00")); is_active=models.BooleanField(default=True)
...
class MarketplaceOffice(TimeStampedModel):
    ...
    name=models.CharField(max_length=180); address=models.CharField(max_length=255,blank=True); phone=models.CharField(max_length=40,blank=True)
    ...
    image=models.ImageField(upload_to="offices/",null=True,blank=True); is_active=models.BooleanField(default=True)
