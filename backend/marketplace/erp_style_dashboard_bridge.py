...
(function(){
  ...
  const workspaceNav=[
    ['/admin/dashboard/control/','⌂','الرئيسية'],
...
def _inject_control_script(html):
    ...
    return html.replace('</body>', FORCE_MOBILE_CSS + BRIDGE_SCRIPT + '</body>')
