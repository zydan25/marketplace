...
RESPONSIVE_CSS = "/static/marketplace/erp-control-responsive.css?v=20260917-3"
...
(function(){
  ...
  function ensureResponsiveStyles(){const old=document.querySelector('link[data-erp-control-style]');if(old&&old.getAttribute('href')!==RESPONSIVE_CSS)old.remove();if(document.querySelector('link[data-erp-control-style]'))return;const link=document.createElement('link');link.rel='stylesheet';link.href=RESPONSIVE_CSS;link.dataset.erpControlStyle='1';document.head.appendChild(link);}
