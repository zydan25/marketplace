...
from marketplace.visual_storefront_builder import builder, create, delete_section, duplicate, publish, reorder, save, upload
urlpatterns = [
    ...
    path("admin/marketplace/storefront-builder/", builder, name="admin-storefront-builder"),
    path("admin/marketplace/storefront-builder/create/", create, name="admin-storefront-builder-create"),
    path("admin/marketplace/storefront-builder/<int:pk>/save/", save, name="admin-storefront-builder-save"),
    path("admin/marketplace/storefront-builder/<int:pk>/duplicate/", duplicate, name="admin-storefront-builder-duplicate"),
    path("admin/marketplace/storefront-builder/<int:pk>/delete/", delete_section, name="admin-storefront-builder-delete"),
    path("admin/marketplace/storefront-builder/<int:pk>/publish/", publish, name="admin-storefront-builder-publish"),
    path("admin/marketplace/storefront-builder/reorder/", reorder, name="admin-storefront-builder-reorder"),
    path("admin/marketplace/storefront-builder/upload/", upload, name="admin-storefront-builder-upload"),
