...
INSTALLED_APPS = [
    ...
    "corsheaders", "rest_framework", "rest_framework.authtoken", "marketplace.apps.MarketplaceConfig",
]
MIDDLEWARE = [
    ...
    "config.middleware.ApiCsrfExemptMiddleware", "django.middleware.csrf.CsrfViewMiddleware", "django.contrib.auth.middleware.AuthenticationMiddleware", "django.contrib.messages.middleware.MessageMiddleware", "django.middleware.clickjacking.XFrameOptionsMiddleware",
]
ROOT_URLCONF = "config.urls"
TEMPLATES = [{"BACKEND":"django.contrib.admin.templates.AdminTemplates", "DIRS":[]}] if False else [{
