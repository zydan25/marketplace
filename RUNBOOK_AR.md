...
آخر Commit منشور على GitHub هو `43e83a8` على الفرع `main` في مستودع [`zydan25/marketplace`](https://github.com/zydan25/marketplace). 
الإصلاحات الإضافية الأخيرة (Commit `43e83a8`):
- توجيه التاجر بعد تسجيل الدخول إلى لوحته الخاصة مباشرة بدلاً من صفحة العميل.
- عرض الرصيد الفعلي في محفظة العميل من الخادم.
- إضافة بنر "الترند الحالي" في الصفحة الرئيسية كصورة يمكن للإدارة التحكم بها.

الإصلاحات السابقة المضمنة: محرر الصور الحالية للمنتج مع الحذف والاحتفاظ الانتقائي، الأصناف المتعددة بصيغة `SKU|اللون|المقاس|السعر|المخزون`، تبويب التجار، صفحة المجموعات، الفلاتر الديناميكية، البحث العربي بالهاشتاج، تثبيت زر إتمام الطلب فوق شريط التبويب، مؤشرات التمرير، وإدارة التخفيضات والشحن المجاني من شاشة إدارة الواجهة. كما يتضمن لوحة تاجر مستقلة عن واجهة العميل، وسجل العمليات والمحافظ وسندات القبض ومسار الهدية والتأكد من وجود المحفظة قبل التحويل.
